  ...
  return (
    <footer className="text-blue space-y-7">
      <div className="flex justify-between">
        ...
        />
        <ul>
          <p className="mb-4 font-bold">歷年主題網站</p>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex items-end gap-5">
          <RadioLinkButton href="https://sitcon.org/fb">
            <FacebookLogo />
          </RadioLinkButton>
          <RadioLinkButton href="https://sitcon.org/twitter">
            <TwitterLogo />
          </RadioLinkButton>
          <RadioLinkButton href="https://sitcon.org/yt">
            <YoutubeLogo />
          </RadioLinkButton>
          <RadioLinkButton href="https://sitcon.org/instagram">
            <InstagramLogo />
          </RadioLinkButton>
          <RadioLinkButton href="https://sitcon.org/flickr">
            <FlickrLogo />
          </RadioLinkButton>
          <RadioLinkButton href="https://sitcon.org/tg">
            <TelegramLogo />
          </RadioLinkButton>
        </div>
      </div>
...
function FooterSubMenu({ title, links }: { title: string; links: Link[] }) {
  return (
    <ul className="flex flex-col gap-2">
      ...
      {links.map((link) => {
        ...
        return (
          <li key={href}>
            <a className="hover:opacity-70" href={href}>
              {text}
            </a>
          </li>
        );
