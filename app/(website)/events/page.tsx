  ...
  return (
    <div className="flex items-start py-8 text-normal-mobile md:text-normal">
      <div className="mx-6 w-full">
        ...
        <section id="guide" className="mt-14">
          <h3 className="text-[22px] font-normal md:text-[26px]">導遊團</h3>
          <p className="mt-4 leading-[200%]">
            ...
            <br />
            <br />
            導遊團會分為上午團以及下午團，上午團的時間為 11:00 到 11:40
            ，集合地點是 3F 白板區旁。下午團的時間為 14:40 到 15:20 ，集合地點是
            2F 咖啡廳 ＆ 靜態海報展旁。
            <br />
            <br />
        ...
        <section id="project_angel" className="mt-20">
          <h3 className="text-[22px] font-normal md:text-[26px]">天使計畫</h3>
          <p className="mt-4 leading-[200%]">
            無論你是初次踏足
        ...
        <section id="whiteboard" className="mt-10">
          <h3 className="text-[22px] font-normal md:text-[26px]">白板大戰</h3>
          <p className="mt-4 leading-[200%]">
        ...
        <section id="lightning_talk" className="mt-20">
          <h3 className="text-[22px] font-normal md:text-[26px]">
            Lightning Talk 閃電秀
          </h3>
          <p className="mt-4 leading-[200%]">
        ...
        <section id="poster" className="mt-20">
          <h3 className="text-[22px] font-normal md:text-[26px]">靜態海報展</h3>
          <p className="mt-4 leading-[200%]">
            這是 SITCON 2024
          ...
          <div className="mt-4 flex md:justify-end">
            <Link
              className="flex h-[60px] w-[190px] items-center justify-center self-center rounded-full bg-primary text-black transition hover:bg-foreground max-[1024px]:active:scale-95 max-sm:px-3 md:w-[153px] md:self-start min-[1024px]:active:bg-primary"
              href="/poster"
              target="_blank"
            >
              查看海報
        ...
        <section id="geocaching" className="mt-10">
          <h3 className="text-[22px] font-normal md:text-[26px]">大地遊戲</h3>
          <p className="mt-4 leading-[200%]">
            第一次參加
