  ...
  return (
    <div className="mx-auto hidden h-[289px] w-full flex-col justify-between md:mb-16 md:flex">
      ...
      <div className="flex h-[67px] w-full justify-between">
        ...
        <div className="h-full w-[40%] rounded-2xl bg-foreground transition-all duration-[0.4s] hover:bg-primary max-[1024px]:active:scale-95 min-[1024px]:active:brightness-90">
          <Link
            target="_blank"
