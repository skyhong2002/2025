  ...
  return (
    <div className="py-8 text-normal-mobile md:text-normal">
      ...
      >
        ...
        <div className="space-y-4">
          <h3 className="text-h3-mobile text-primary md:text-h3">海報格式</h3>
      ...
      >
        ...
        <p className="text-normal-mobile font-normal leading-10 tracking-wider md:text-normal">
          您可以從{" "}
          <Link href="https://sitcon.org/2024" target="_blank">
            SITCON 2024
          </Link>{" "}
      ...
      >
        ...
        <p className="text-normal-mobile font-normal leading-10 tracking-wider md:text-normal">
          若您的稿件被予以錄取，您需要依據投稿時提供的資訊將專案/研究內容製作成一完整海報。海報之內容除題目與摘要之外，建議依序可包含前言、方法或技術、成果展示、結論及參考資料等，您可根據專案或研究的特性自行斟酌內容安排，以不超過海報尺寸為限。請以直版寬
          841 mm、高 1189 mm （A0 大小）規格製作為 PDF 檔案，並於 2025 年 2 月
          16
