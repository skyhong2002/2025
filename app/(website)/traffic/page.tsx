    ...
    <div className="flex w-full flex-col items-start justify-center gap-8 text-[#ffffff]">
      ...
      <section id="map" className="flex w-full flex-col gap-8">
        ...
        <div className="flex w-full justify-between gap-2 text-h3-mobile font-bold md:gap-6 md:text-h3">
          <button
            onClick={() => setTransportation("shuttle")}
            className="flex h-[60px] flex-grow items-center justify-center rounded-xl bg-[#DEE6EB] text-black"
          >
            大眾接駁車
          </button>
          <button
      ...
      >
        ...
        <div className="flex w-full">
          ...
          <div className="flex flex-col justify-center">
            <span className="material-symbols-outlined !text-[86px]">
              airport_shuttle
            </span>
    ...
    <>
        ...
        <div className="flex w-[30%] flex-col gap-[5%]">
          <div className="flex h-[30%] items-center justify-center">
            <div className="relative h-min w-full">
              ...
              >
                <g clip-path="url(#clip0_129_1926)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
      ...
      >
        ...
        <div className="flex flex-row justify-between gap-[4%]">
          <div className="flex w-[48%] flex-col items-center gap-4">
            <div className="flex w-full flex-row gap-4">
              <div className="w-[50%] border border-[#ffffff] border-x-transparent border-b-transparent"></div>
              <div className="w-[50%] border border-[#ffffff] border-x-transparent border-b-transparent"></div>
            </div>
          </div>
          <div className="flex w-[48%] flex-col items-center gap-4">
            <div className="w-full border border-[#ffffff] border-x-transparent border-b-transparent"></div>
          </div>
        </div>
      </section>
    </>
