            ...
            <div className="flex w-full flex-col items-center gap-4">
              ...
              <div className="flex max-w-[800px] flex-col justify-center gap-3 sm:gap-5">
                <div className="flex flex-row justify-center gap-3 sm:gap-5">
                  <Link
                    href="/cfp/normal"
                    className="w-full whitespace-nowrap text-nowrap rounded-[50px] bg-[#FFFFFF] px-8 py-1 text-center transition hover:bg-foreground max-[1024px]:active:scale-95 max-sm:px-3 min-[1024px]:active:bg-primary"
                  >
                    一般議程
                  </Link>
                  <Link
                ...
                <Link
                  ...
                  className="w-auto rounded-[50px] bg-[#FFFFFF] px-8 py-1 text-center transition hover:bg-foreground max-[1024px]:active:scale-95 max-sm:w-full min-[1024px]:active:bg-primary"
                >
                  把截止日期加入行事曆
                </Link>
              </div>
                ...
                <div>
                  ...
                  <div className="flex gap-6 pt-14 max-[1024px]:grid max-[1024px]:grid-cols-8 max-[1024px]:gap-5 max-sm:grid-cols-2">
                    <Link
                      ...
                      className="w-[140px] rounded-[50px] bg-secondary py-3 text-center font-bold transition hover:bg-foreground max-[1024px]:col-span-8 max-[1024px]:w-auto max-[1024px]:rounded-lg max-[1024px]:text-[18px] max-[1024px]:active:scale-95 max-[712px]:my-auto max-[712px]:text-[14px] max-sm:col-span-2 max-sm:rounded-[72px] max-sm:text-[18px] max-sm:font-normal min-[1024px]:active:bg-primary"
                    >
                      預約跳坑表單
                    </Link>
                    <Link
                      ...
                      className="w-[140px] rounded-[50px] bg-secondary py-3 text-center font-bold transition hover:bg-foreground max-[1024px]:col-span-5 max-[1024px]:w-auto max-[1024px]:rounded-lg max-[1024px]:text-[18px] max-[1024px]:active:scale-95 max-[712px]:my-auto max-[712px]:text-[14px] max-sm:col-span-1 max-sm:rounded-[72px] max-sm:text-[18px] max-sm:font-normal min-[1024px]:active:bg-primary"
                    >
                      訂閱郵件論壇
                    </Link>
                    <Link
                      ...
                      className="w-[140px] rounded-[50px] bg-secondary py-3 text-center font-bold transition hover:bg-foreground max-[1024px]:col-span-3 max-[1024px]:w-auto max-[1024px]:rounded-lg max-[1024px]:text-[18px] max-[1024px]:active:scale-95 max-[712px]:my-auto max-[712px]:text-[14px] max-sm:col-span-1 max-sm:rounded-[72px] max-sm:text-[18px] max-sm:font-normal min-[1024px]:active:bg-primary"
                    >
                      查看 GitLab
                    </Link>
                  </div>
