        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="absolute inset-5 flex flex-col items-center justify-between rounded-xl bg-white p-8 max-md:hidden md:static md:max-w-[70%] md:justify-start lg:max-w-[60%]"
            >
              <div className="flex">
