...
export default function Home() {
  ...
  return (
    <>
      <div
        className="relative h-[calc(100svh-64px)] min-h-[600px] bg-white bg-cover bg-[left_20%_center] max-[820px]:bg-gray max-sm:h-[calc(100svh-140px)] lg:bg-center"
        style={{
          backgroundImage: `url('')`,
        }}
      >
      ...
      <div className="relative grid grid-cols-2 bg-light-brown bg-cover bg-[left_20%_center] px-10 max-[820px]:px-6 max-sm:grid-cols-none max-sm:bg-blue max-sm:text-center lg:bg-center">
        <div className="flex">
      ...
      {/* Tablet Layout */}
      <div className="relative grid grid-rows-2 gap-4 bg-light-brown bg-cover bg-[left_20%_center] px-10 max-sm:hidden min-[820px]:hidden lg:bg-center">
